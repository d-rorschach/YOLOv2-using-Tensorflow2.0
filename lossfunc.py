# -*- coding: utf-8 -*-
"""
Created on Thu Aug 13 11:05:46 2020
...
def adjust_scale_prediction(y_pred, cell_grid, ANCHORS):    
    ...
    pred_box_xy =tf.add( tf.sigmoid(y_pred[..., :2]) , cell_grid) # bx, by
...
def get_conf_mask(best_ious, true_box_conf, true_box_conf_IOU,LAMBDA_NO_OBJECT, LAMBDA_OBJECT):    
    ...
    conf_mask = tf.compat.v1.to_float(best_ious < 0.6) * (1 - true_box_conf) * LAMBDA_NO_OBJECT
